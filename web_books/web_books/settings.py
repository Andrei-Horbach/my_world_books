...
SECRET_KEY = 'django-insecure-+)@q2vt$=oj6!+0xgt3$hgc0gez&poq1=ia-apl#cs97cl%$g3'
...
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"  # Для отправки нового пароля на почту (на этом примере
# отправляем просто в терминал)
